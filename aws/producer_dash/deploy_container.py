...
def list_tags():
  ...
  print(json.dumps(client.list_images(repositoryName="cr-producer"), sort_keys=True, indent=2))
  pass
...
def tag_image(tag):
  ...
  cmd = ['docker','tag',hashtag,'066650776666.dkr.ecr.eu-central-1.amazonaws.com/cr-producer:'+tag]
  print(cmd)
  ...
  cmd=['docker','push','066650776666.dkr.ecr.eu-central-1.amazonaws.com/cr-producer:'+tag]
  print(cmd) 
  out = subprocess.run(['docker','push','066650776666.dkr.ecr.eu-central-1.amazonaws.com/cr-producer:'+tag], capture_output=True)
